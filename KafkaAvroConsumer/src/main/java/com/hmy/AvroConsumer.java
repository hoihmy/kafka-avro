...
public class AvroConsumer {
    ...
    private static final String CONSUMER_GROUP_ID = "customer-message-consumer-group-3333";

    public static void main(String[] args) {
        // Kafka Consumer Configurations
        final Properties properties = getKafkaAvroConsumerConfiguration();
    ...
    private static Properties getKafkaAvroConsumerConfiguration() {
